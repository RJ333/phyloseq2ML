...
The example phyloseq object used in the vignette contains a large amount of 
sample data variables. I will explain below what each column means in case you
want to have a closer look:

## Data describing the sediment sampling:
* Udemm: A number given to each sediment which was analyzed for UXOs and further 
parameters. Multiple libraries can refer to the same Udemm number. UDEMM was 
the name of the [project](https://udemm.geomar.de/).
* Cruise_ID: On which cruise was the sediment collected?
* Station_ID: From which station does the sediment come?
* Sample_Type: Sediments from the surface or from a multicorer? 
* Experiment: If available, can the sediment be assigned to a certain 
experiment or sampling campaign purpose?
* Area: In what informal area was the sediment taken?
...
* Date: The date the sediments were collected.
* Time: The time the sediments were collected.
...
## The measured concentrations of various unexploded ordnance (UXO):
* TNT: 2,4,6-Trinitrotoluene
* ADNT_2: 2-Amino-4,6-dinitrotoluene
* ADNT_4: 4-Amino-2,6-dinitrotoluene
* DANT_2.4: 2,4-Diamino-6-nitrotoluene
* DANT_2.6: 2,6-Diamino-4-nitrotoluene
* DNT_2.4: 2,4-Dinitrotoluene (1-methyl-2,4-dinitro benzene)
* DNT_2.6: 2,6-Dinitrotoluene (1-methyl-2,6-dinitro benzene)
...
* Sum_ng_g: The sum of all UXOs measured in ng/g wet sediment.
* UXO_sum: The sum of all UXOs measured in pmol/g wet sediment.
* Main_UXO_sum: The sum of the most frequent occurring UXOs TNT, DANT_2.6, 
DANT_2.4, ADNT_4, ADNT_2.
